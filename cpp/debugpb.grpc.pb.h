   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      // Read a value arbitrarily for a key.
      // Note: Server uses key directly w/o any encoding.
      virtual void Get(::grpc::ClientContext* context, const ::debugpb::GetRequest* request, ::debugpb::GetResponse* response, std::function<void(::grpc::Status)>) = 0;
      // Read raft info.
      virtual void RaftLog(::grpc::ClientContext* context, const ::debugpb::RaftLogRequest* request, ::debugpb::RaftLogResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void RegionInfo(::grpc::ClientContext* context, const ::debugpb::RegionInfoRequest* request, ::debugpb::RegionInfoResponse* response, std::function<void(::grpc::Status)>) = 0;
      // Calculate size of a region.
      // Note: DO NOT CALL IT IN PRODUCTION, it's really expensive.
      virtual void RegionSize(::grpc::ClientContext* context, const ::debugpb::RegionSizeRequest* request, ::debugpb::RegionSizeResponse* response, std::function<void(::grpc::Status)>) = 0;
      // Scan a specific range.
      // Note: DO NOT CALL IT IN PRODUCTION, it's really expensive.
      //       Server uses keys directly w/o any encoding.
      // Compact a column family in a specified range.
      // Note: Server uses keys directly w/o any encoding.
      virtual void Compact(::grpc::ClientContext* context, const ::debugpb::CompactRequest* request, ::debugpb::CompactResponse* response, std::function<void(::grpc::Status)>) = 0;
      // Inject a fail point. Currently, it's only used in tests.
      // Note: DO NOT CALL IT IN PRODUCTION.
      virtual void InjectFailPoint(::grpc::ClientContext* context, const ::debugpb::InjectFailPointRequest* request, ::debugpb::InjectFailPointResponse* response, std::function<void(::grpc::Status)>) = 0;
      // Recover from a fail point.
      virtual void RecoverFailPoint(::grpc::ClientContext* context, const ::debugpb::RecoverFailPointRequest* request, ::debugpb::RecoverFailPointResponse* response, std::function<void(::grpc::Status)>) = 0;
      // List all fail points.
      virtual void ListFailPoints(::grpc::ClientContext* context, const ::debugpb::ListFailPointsRequest* request, ::debugpb::ListFailPointsResponse* response, std::function<void(::grpc::Status)>) = 0;
      // Get Metrics
      virtual void GetMetrics(::grpc::ClientContext* context, const ::debugpb::GetMetricsRequest* request, ::debugpb::GetMetricsResponse* response, std::function<void(::grpc::Status)>) = 0;
      // Do a consistent check for a region.
      virtual void CheckRegionConsistency(::grpc::ClientContext* context, const ::debugpb::RegionConsistencyCheckRequest* request, ::debugpb::RegionConsistencyCheckResponse* response, std::function<void(::grpc::Status)>) = 0;
      // dynamically modify tikv's config
      virtual void ModifyTikvConfig(::grpc::ClientContext* context, const ::debugpb::ModifyTikvConfigRequest* request, ::debugpb::ModifyTikvConfigResponse* response, std::function<void(::grpc::Status)>) = 0;
      // Get region properties
      virtual void GetRegionProperties(::grpc::ClientContext* context, const ::debugpb::GetRegionPropertiesRequest* request, ::debugpb::GetRegionPropertiesResponse* response, std::function<void(::grpc::Status)>) = 0;
    };
  ...
  class Stub final : public StubInterface {
   public:
    ...
    class experimental_async final :
     ...
     public:
      void Get(::grpc::ClientContext* context, const ::debugpb::GetRequest* request, ::debugpb::GetResponse* response, std::function<void(::grpc::Status)>) override;
      void RaftLog(::grpc::ClientContext* context, const ::debugpb::RaftLogRequest* request, ::debugpb::RaftLogResponse* response, std::function<void(::grpc::Status)>) override;
      void RegionInfo(::grpc::ClientContext* context, const ::debugpb::RegionInfoRequest* request, ::debugpb::RegionInfoResponse* response, std::function<void(::grpc::Status)>) override;
      void RegionSize(::grpc::ClientContext* context, const ::debugpb::RegionSizeRequest* request, ::debugpb::RegionSizeResponse* response, std::function<void(::grpc::Status)>) override;
      void Compact(::grpc::ClientContext* context, const ::debugpb::CompactRequest* request, ::debugpb::CompactResponse* response, std::function<void(::grpc::Status)>) override;
      void InjectFailPoint(::grpc::ClientContext* context, const ::debugpb::InjectFailPointRequest* request, ::debugpb::InjectFailPointResponse* response, std::function<void(::grpc::Status)>) override;
      void RecoverFailPoint(::grpc::ClientContext* context, const ::debugpb::RecoverFailPointRequest* request, ::debugpb::RecoverFailPointResponse* response, std::function<void(::grpc::Status)>) override;
      void ListFailPoints(::grpc::ClientContext* context, const ::debugpb::ListFailPointsRequest* request, ::debugpb::ListFailPointsResponse* response, std::function<void(::grpc::Status)>) override;
      void GetMetrics(::grpc::ClientContext* context, const ::debugpb::GetMetricsRequest* request, ::debugpb::GetMetricsResponse* response, std::function<void(::grpc::Status)>) override;
      void CheckRegionConsistency(::grpc::ClientContext* context, const ::debugpb::RegionConsistencyCheckRequest* request, ::debugpb::RegionConsistencyCheckResponse* response, std::function<void(::grpc::Status)>) override;
      void ModifyTikvConfig(::grpc::ClientContext* context, const ::debugpb::ModifyTikvConfigRequest* request, ::debugpb::ModifyTikvConfigResponse* response, std::function<void(::grpc::Status)>) override;
      void GetRegionProperties(::grpc::ClientContext* context, const ::debugpb::GetRegionPropertiesRequest* request, ::debugpb::GetRegionPropertiesResponse* response, std::function<void(::grpc::Status)>) override;
     private:
      friend class Stub;
