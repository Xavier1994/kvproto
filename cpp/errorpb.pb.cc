...
void protobuf_AssignDesc_errorpb_2eproto() {
  ...
  static const int ServerIsBusy_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ServerIsBusy, reason_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ServerIsBusy, backoff_ms_),
  };
...
void protobuf_AddDesc_errorpb_2eproto_impl() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "o\310\342\036\001\340\342\036\001\320\342\036\001b\006proto3", 901);
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(16)) goto parse_backoff_ms;
        break;
      }
...
void ServerIsBusy::InternalSwap(ServerIsBusy* other) {
  ...
  std::swap(backoff_ms_, other->backoff_ms_);
  _internal_metadata_.Swap(&other->_internal_metadata_);
  std::swap(_cached_size_, other->_cached_size_);
}
...
// optional uint64 backoff_ms = 2;
void ServerIsBusy::clear_backoff_ms() {
  backoff_ms_ = GOOGLE_ULONGLONG(0);
}
::google::protobuf::uint64 ServerIsBusy::backoff_ms() const {
  // @@protoc_insertion_point(field_get:errorpb.ServerIsBusy.backoff_ms)
  return backoff_ms_;
}
void ServerIsBusy::set_backoff_ms(::google::protobuf::uint64 value) {
