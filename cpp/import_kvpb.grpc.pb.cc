...
void ImportKV::Stub::experimental_async::SwitchMode(::grpc::ClientContext* context, const ::import_kvpb::SwitchModeRequest* request, ::import_kvpb::SwitchModeResponse* response, std::function<void(::grpc::Status)> f) {
  return ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_SwitchMode_, context, request, response, std::move(f));
}
...
void ImportKV::Stub::experimental_async::OpenEngine(::grpc::ClientContext* context, const ::import_kvpb::OpenEngineRequest* request, ::import_kvpb::OpenEngineResponse* response, std::function<void(::grpc::Status)> f) {
  return ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_OpenEngine_, context, request, response, std::move(f));
}
...
void ImportKV::Stub::experimental_async::CloseEngine(::grpc::ClientContext* context, const ::import_kvpb::CloseEngineRequest* request, ::import_kvpb::CloseEngineResponse* response, std::function<void(::grpc::Status)> f) {
  return ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_CloseEngine_, context, request, response, std::move(f));
}
...
void ImportKV::Stub::experimental_async::ImportEngine(::grpc::ClientContext* context, const ::import_kvpb::ImportEngineRequest* request, ::import_kvpb::ImportEngineResponse* response, std::function<void(::grpc::Status)> f) {
  return ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_ImportEngine_, context, request, response, std::move(f));
}
...
void ImportKV::Stub::experimental_async::CleanupEngine(::grpc::ClientContext* context, const ::import_kvpb::CleanupEngineRequest* request, ::import_kvpb::CleanupEngineResponse* response, std::function<void(::grpc::Status)> f) {
  return ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_CleanupEngine_, context, request, response, std::move(f));
}
...
void ImportKV::Stub::experimental_async::CompactCluster(::grpc::ClientContext* context, const ::import_kvpb::CompactClusterRequest* request, ::import_kvpb::CompactClusterResponse* response, std::function<void(::grpc::Status)> f) {
  return ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_CompactCluster_, context, request, response, std::move(f));
}
