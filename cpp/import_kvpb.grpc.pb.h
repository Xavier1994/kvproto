   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      // Switch the target cluster to normal/import mode.
      virtual void SwitchMode(::grpc::ClientContext* context, const ::import_kvpb::SwitchModeRequest* request, ::import_kvpb::SwitchModeResponse* response, std::function<void(::grpc::Status)>) = 0;
      // Open an engine.
      virtual void OpenEngine(::grpc::ClientContext* context, const ::import_kvpb::OpenEngineRequest* request, ::import_kvpb::OpenEngineResponse* response, std::function<void(::grpc::Status)>) = 0;
      // Open a write stream to the engine.
      // Close the engine.
      virtual void CloseEngine(::grpc::ClientContext* context, const ::import_kvpb::CloseEngineRequest* request, ::import_kvpb::CloseEngineResponse* response, std::function<void(::grpc::Status)>) = 0;
      // Import the engine to the target cluster.
      virtual void ImportEngine(::grpc::ClientContext* context, const ::import_kvpb::ImportEngineRequest* request, ::import_kvpb::ImportEngineResponse* response, std::function<void(::grpc::Status)>) = 0;
      // Clean up the engine.
      virtual void CleanupEngine(::grpc::ClientContext* context, const ::import_kvpb::CleanupEngineRequest* request, ::import_kvpb::CleanupEngineResponse* response, std::function<void(::grpc::Status)>) = 0;
      // Compact the target cluster for better performance.
      virtual void CompactCluster(::grpc::ClientContext* context, const ::import_kvpb::CompactClusterRequest* request, ::import_kvpb::CompactClusterResponse* response, std::function<void(::grpc::Status)>) = 0;
    };
  ...
  class Stub final : public StubInterface {
   public:
    ...
    class experimental_async final :
     ...
     public:
      void SwitchMode(::grpc::ClientContext* context, const ::import_kvpb::SwitchModeRequest* request, ::import_kvpb::SwitchModeResponse* response, std::function<void(::grpc::Status)>) override;
      void OpenEngine(::grpc::ClientContext* context, const ::import_kvpb::OpenEngineRequest* request, ::import_kvpb::OpenEngineResponse* response, std::function<void(::grpc::Status)>) override;
      void CloseEngine(::grpc::ClientContext* context, const ::import_kvpb::CloseEngineRequest* request, ::import_kvpb::CloseEngineResponse* response, std::function<void(::grpc::Status)>) override;
      void ImportEngine(::grpc::ClientContext* context, const ::import_kvpb::ImportEngineRequest* request, ::import_kvpb::ImportEngineResponse* response, std::function<void(::grpc::Status)>) override;
      void CleanupEngine(::grpc::ClientContext* context, const ::import_kvpb::CleanupEngineRequest* request, ::import_kvpb::CleanupEngineResponse* response, std::function<void(::grpc::Status)>) override;
      void CompactCluster(::grpc::ClientContext* context, const ::import_kvpb::CompactClusterRequest* request, ::import_kvpb::CompactClusterResponse* response, std::function<void(::grpc::Status)>) override;
     private:
      friend class Stub;
