...
void ImportSST::Stub::experimental_async::SwitchMode(::grpc::ClientContext* context, const ::import_sstpb::SwitchModeRequest* request, ::import_sstpb::SwitchModeResponse* response, std::function<void(::grpc::Status)> f) {
...
void ImportSST::Stub::experimental_async::Ingest(::grpc::ClientContext* context, const ::import_sstpb::IngestRequest* request, ::import_sstpb::IngestResponse* response, std::function<void(::grpc::Status)> f) {
  return ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_Ingest_, context, request, response, std::move(f));
}
...
void ImportSST::Stub::experimental_async::Compact(::grpc::ClientContext* context, const ::import_sstpb::CompactRequest* request, ::import_sstpb::CompactResponse* response, std::function<void(::grpc::Status)> f) {
