   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      virtual void Bootstrap(::grpc::ClientContext* context, const ::pdpb::BootstrapRequest* request, ::pdpb::BootstrapResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void IsBootstrapped(::grpc::ClientContext* context, const ::pdpb::IsBootstrappedRequest* request, ::pdpb::IsBootstrappedResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void AllocID(::grpc::ClientContext* context, const ::pdpb::AllocIDRequest* request, ::pdpb::AllocIDResponse* response, std::function<void(::grpc::Status)>) = 0;
      ...
      virtual void PutStore(::grpc::ClientContext* context, const ::pdpb::PutStoreRequest* request, ::pdpb::PutStoreResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void GetAllStores(::grpc::ClientContext* context, const ::pdpb::GetAllStoresRequest* request, ::pdpb::GetAllStoresResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void StoreHeartbeat(::grpc::ClientContext* context, const ::pdpb::StoreHeartbeatRequest* request, ::pdpb::StoreHeartbeatResponse* response, std::function<void(::grpc::Status)>) = 0;
      ...
      virtual void GetPrevRegion(::grpc::ClientContext* context, const ::pdpb::GetRegionRequest* request, ::pdpb::GetRegionResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void GetRegionByID(::grpc::ClientContext* context, const ::pdpb::GetRegionByIDRequest* request, ::pdpb::GetRegionResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void AskSplit(::grpc::ClientContext* context, const ::pdpb::AskSplitRequest* request, ::pdpb::AskSplitResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void ReportSplit(::grpc::ClientContext* context, const ::pdpb::ReportSplitRequest* request, ::pdpb::ReportSplitResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void AskBatchSplit(::grpc::ClientContext* context, const ::pdpb::AskBatchSplitRequest* request, ::pdpb::AskBatchSplitResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void ReportBatchSplit(::grpc::ClientContext* context, const ::pdpb::ReportBatchSplitRequest* request, ::pdpb::ReportBatchSplitResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void GetClusterConfig(::grpc::ClientContext* context, const ::pdpb::GetClusterConfigRequest* request, ::pdpb::GetClusterConfigResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void PutClusterConfig(::grpc::ClientContext* context, const ::pdpb::PutClusterConfigRequest* request, ::pdpb::PutClusterConfigResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void ScatterRegion(::grpc::ClientContext* context, const ::pdpb::ScatterRegionRequest* request, ::pdpb::ScatterRegionResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void GetGCSafePoint(::grpc::ClientContext* context, const ::pdpb::GetGCSafePointRequest* request, ::pdpb::GetGCSafePointResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void UpdateGCSafePoint(::grpc::ClientContext* context, const ::pdpb::UpdateGCSafePointRequest* request, ::pdpb::UpdateGCSafePointResponse* response, std::function<void(::grpc::Status)>) = 0;
    };
   ...
   public:
    ...
    class experimental_async final :
     ...
     public:
      ...
      void Bootstrap(::grpc::ClientContext* context, const ::pdpb::BootstrapRequest* request, ::pdpb::BootstrapResponse* response, std::function<void(::grpc::Status)>) override;
      void IsBootstrapped(::grpc::ClientContext* context, const ::pdpb::IsBootstrappedRequest* request, ::pdpb::IsBootstrappedResponse* response, std::function<void(::grpc::Status)>) override;
      void AllocID(::grpc::ClientContext* context, const ::pdpb::AllocIDRequest* request, ::pdpb::AllocIDResponse* response, std::function<void(::grpc::Status)>) override;
      ...
      void PutStore(::grpc::ClientContext* context, const ::pdpb::PutStoreRequest* request, ::pdpb::PutStoreResponse* response, std::function<void(::grpc::Status)>) override;
      void GetAllStores(::grpc::ClientContext* context, const ::pdpb::GetAllStoresRequest* request, ::pdpb::GetAllStoresResponse* response, std::function<void(::grpc::Status)>) override;
      void StoreHeartbeat(::grpc::ClientContext* context, const ::pdpb::StoreHeartbeatRequest* request, ::pdpb::StoreHeartbeatResponse* response, std::function<void(::grpc::Status)>) override;
      ...
      void GetPrevRegion(::grpc::ClientContext* context, const ::pdpb::GetRegionRequest* request, ::pdpb::GetRegionResponse* response, std::function<void(::grpc::Status)>) override;
      void GetRegionByID(::grpc::ClientContext* context, const ::pdpb::GetRegionByIDRequest* request, ::pdpb::GetRegionResponse* response, std::function<void(::grpc::Status)>) override;
      void AskSplit(::grpc::ClientContext* context, const ::pdpb::AskSplitRequest* request, ::pdpb::AskSplitResponse* response, std::function<void(::grpc::Status)>) override;
      void ReportSplit(::grpc::ClientContext* context, const ::pdpb::ReportSplitRequest* request, ::pdpb::ReportSplitResponse* response, std::function<void(::grpc::Status)>) override;
      void AskBatchSplit(::grpc::ClientContext* context, const ::pdpb::AskBatchSplitRequest* request, ::pdpb::AskBatchSplitResponse* response, std::function<void(::grpc::Status)>) override;
      void ReportBatchSplit(::grpc::ClientContext* context, const ::pdpb::ReportBatchSplitRequest* request, ::pdpb::ReportBatchSplitResponse* response, std::function<void(::grpc::Status)>) override;
      void GetClusterConfig(::grpc::ClientContext* context, const ::pdpb::GetClusterConfigRequest* request, ::pdpb::GetClusterConfigResponse* response, std::function<void(::grpc::Status)>) override;
      void PutClusterConfig(::grpc::ClientContext* context, const ::pdpb::PutClusterConfigRequest* request, ::pdpb::PutClusterConfigResponse* response, std::function<void(::grpc::Status)>) override;
      void ScatterRegion(::grpc::ClientContext* context, const ::pdpb::ScatterRegionRequest* request, ::pdpb::ScatterRegionResponse* response, std::function<void(::grpc::Status)>) override;
      void GetGCSafePoint(::grpc::ClientContext* context, const ::pdpb::GetGCSafePointRequest* request, ::pdpb::GetGCSafePointResponse* response, std::function<void(::grpc::Status)>) override;
      void UpdateGCSafePoint(::grpc::ClientContext* context, const ::pdpb::UpdateGCSafePointRequest* request, ::pdpb::UpdateGCSafePointResponse* response, std::function<void(::grpc::Status)>) override;
     private:
      friend class Stub;
