...
type TikvClient interface {
	...
	RawCAS(ctx context.Context, in *kvrpcpb.RawCASRequest, opts ...grpc.CallOption) (*kvrpcpb.RawCASResponse, error)
	...
	GetRegionState(ctx context.Context, in *kvrpcpb.GetRegionStateRequest, opts ...grpc.CallOption) (*kvrpcpb.GetRegionStateResponse, error)
}
...
func (c *tikvClient) RawCAS(ctx context.Context, in *kvrpcpb.RawCASRequest, opts ...grpc.CallOption) (*kvrpcpb.RawCASResponse, error) {
	out := new(kvrpcpb.RawCASResponse)
	err := c.cc.Invoke(ctx, "/tikvpb.Tikv/RawCAS", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tikvClient) GetRegionState(ctx context.Context, in *kvrpcpb.GetRegionStateRequest, opts ...grpc.CallOption) (*kvrpcpb.GetRegionStateResponse, error) {
	out := new(kvrpcpb.GetRegionStateResponse)
	err := c.cc.Invoke(ctx, "/tikvpb.Tikv/GetRegionState", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TikvServer interface {
	...
	RawCAS(context.Context, *kvrpcpb.RawCASRequest) (*kvrpcpb.RawCASResponse, error)
	...
	// get region state from leader, why we get region state from leader,
	// because for some state, eg. last_index, committed_index... get from pd is too slow
	GetRegionState(context.Context, *kvrpcpb.GetRegionStateRequest) (*kvrpcpb.GetRegionStateResponse, error)
}
...
func _Tikv_RawCAS_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(kvrpcpb.RawCASRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TikvServer).RawCAS(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tikvpb.Tikv/RawCAS",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TikvServer).RawCAS(ctx, req.(*kvrpcpb.RawCASRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Tikv_GetRegionState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(kvrpcpb.GetRegionStateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TikvServer).GetRegionState(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tikvpb.Tikv/GetRegionState",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TikvServer).GetRegionState(ctx, req.(*kvrpcpb.GetRegionStateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Tikv_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetRegionState",
			Handler:    _Tikv_GetRegionState_Handler,
		},
	},
...
func init() { proto.RegisterFile("tikvpb.proto", fileDescriptor_tikvpb_7fcd775f683ea6ae) }

var fileDescriptor_tikvpb_7fcd775f683ea6ae = []byte{
	// 742 bytes of a gzipped FileDescriptorProto
	,
}
